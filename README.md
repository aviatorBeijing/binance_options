...
| ```python ivsurf/on_spot.py --contracts BTC-250328-88000-C,BTC-250328-88000-P  --cap_call 500 --cap_call 600 --alloc 1,1,2,4,8```  |   | place 4 orders for put & call, with capital allocation in mind (need to start ticker.sh first) |
