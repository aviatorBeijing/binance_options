...
def run():
    parser = argparse.ArgumentParser(description='sample Binance market maker')
    parser.add_argument('command', nargs='?', help='Instrument symbol on Binance or "setup" for first-time config')
