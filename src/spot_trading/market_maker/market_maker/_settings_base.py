...
# order amend/replaces are done, you may hit a ratelimit. If so, email Binance if you feel you need a higher limit.
LOOP_INTERVAL = 5
...
ORDERID_PREFIX = "mm_binance_"

# If any of these files (and this file) changes, reload the bot.
WATCHED_FILES = [join('market_maker', 'market_maker.py'), join('market_maker', 'binance.py'), 'settings.py']
