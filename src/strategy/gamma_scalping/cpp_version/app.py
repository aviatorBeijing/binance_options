...
# Simulate asset price paths using C++-optimized function
S_paths = gamma_scalping.simulate_gbm_paths(S0, r, sigma, T, dt, n_sim)

# Gamma scalping PnL using C++-optimized function
pnl_gamma_scalping = gamma_scalping.gamma_scalping(S_paths, K, r, sigma, T, dt)
